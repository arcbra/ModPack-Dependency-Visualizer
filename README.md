...
<img src="/src/imgs/index_window_icon.svg" width="48">
<img src="/src/imgs/graph_window_icon.svg" width="48">

<!-- [![Product Name Screen Shot][graph-page-picture]](https://example.com) -->
...
This project makes use of the manifest inside the minecraft mods in JAR format. This makes possible to establish relations between the mods and generate a network graph, so you can clearly see which mods are left alone and how are the connections established. Here is an example of the
Cobblemon Modpack [NeoForge]:

![Cobblemon Neoforge][cobblemon-graph]
...
- [x] Add the ability to mark orphan nodes as check orphans.
...
This project was heavily inspired by some other _ModPack makers_ projects, and it's meant to complement them.
...
[cobblemon-graph]: /README_imgs//tutorial/cobblemon_forge.png
